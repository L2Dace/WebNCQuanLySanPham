...
namespace QuanLySanPhamTHTKW.App_code
{
    public class XuLyDuLieu
    {
        ...
        public XuLyDuLieu()
        {
            ...
            con.ConnectionString = @"Data Source=(Localdb)\MSSQLLocalDB;AttachDbFilename=D:\TH Web NC\QuanLySanPhamTHTKW\App_data\QuanLySanPham.mdf;Integrated Security=True";
        }
